...
export const DEFAULT_DATA_DIR = path.resolve(APPLICATION_DIRECTORY, 'actual-data');

export const DEFAULT_CONFIG_FILE = path.resolve(APPLICATION_DIRECTORY, 'config.toml');
