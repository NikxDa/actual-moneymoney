...
describe('Importer', () => {
    ...
    it('warns when MoneyMoney only provides unchecked transactions but unchecked imports are disabled', async () => {
        const config: Config = {
            payeeTransformation: {
                enabled: false,
                skipModelValidation: false,
    ...
    it('creates a starting balance when only unchecked MoneyMoney transactions exist for the account', async () => {
        const config: Config = {
            payeeTransformation: {
                enabled: false,
                skipModelValidation: false,
    ...
    it('imports new transactions for mapped accounts while skipping duplicates and unchecked entries', async () => {
        ...
        const accountMap = {
            getMap: () =>
                new Map([
                    [primaryAccount, primaryActualAccount],
                    [savingsAccount, savingsActualAccount],
                ]),
        };
    ...
    it('rejects MoneyMoney transactions when the amount is infinite', async () => {
        const config: Config = {
            payeeTransformation: {
                enabled: false,
                skipModelValidation: false,
        ...
        moneyMoneyTransactionsMock.mockResolvedValue([
            {
                ...
                purpose: 'Corrupted export',
                comment: '',
                valueDate: new Date('2024-01-16T00:00:00Z'),
                bookingDate: new Date('2024-01-16T00:00:00Z'),
        ...
        ).rejects.toThrow(/amount is missing or invalid/);
